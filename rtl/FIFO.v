...
module FIFO #(parameter DSIZE = 8,
    ...
    output rempty,                  // Read empty signal(~sample_valid)
    input [DSIZE-1:0] wdata,        // Input data - data to be written
    input winc, wclk, wrst_n,       // Write increment(SET TO 1), write clock, write reset
    input rinc, rclk, rrst_n        // Read increment(~REMPTY), read clock, read reset
    );
