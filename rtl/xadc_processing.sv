...
module xadc_processing #(
    parameter int SCALING_FACTOR = 825,
    parameter int SHIFT_FACTOR   = 14
) (
    input  logic        clk,
    input  logic        reset,
    input  logic        ready,
    ...
    averager #(
        .power(9), // 2**(power) samples, default is 2**8 = 256 samples (4^4 = 256 samples, adds 4 bits of ADC resolution)
